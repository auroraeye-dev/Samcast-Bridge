...
// The Mac half of the Samcast bridge.
//
// It deliberately adds nothing to SamcastCore: the gesture maths, the
...
let package = Package(
    ...
    dependencies: [
        ...
        .package(path: "../../Samcast")
    ],
    targets: [
        .target(
            name: "QuackBridge",
            dependencies: [.product(name: "SamcastCore", package: "Samcast")]
        ),
        .executableTarget(
            name: "BridgeCLI",
            dependencies: [
                "QuackBridge",
                .product(name: "SamcastCore", package: "Samcast"),
                .product(name: "SamcastPlatform", package: "Samcast")
            ]
        ),
        .executableTarget(
            name: "BridgeCheck",
            dependencies: ["QuackBridge", .product(name: "SamcastCore", package: "Samcast")]
        )
    ]
)
